  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:4000/api/travel-company/delete-travel-company/${id}`,
        {
          method: "DELETE",
          headers: {
      ...
      if (response.ok) {
        alert("Travel company deleted successfully!");
        setId("");
      } else {
...
export default DeleteTravelCompany;
